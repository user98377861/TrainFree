...
MODEL_TD_DIR = '/hpc2hdd/home/wenjinqi/low_quality_extract/grandqc/models'
MODEL_TD_NAME = 'GrandQC_MPP1.pth'
MPP_MODEL_TD = 10
M_P_S_MODEL_TD = 512
...
model = torch.load(os.path.join(MODEL_TD_DIR, MODEL_TD_NAME), map_location='cpu')
model.to(DEVICE)
model.eval()
